...
import { SqComponentWithExternalScopedCss } from '@/src'
export interface Props extends React.HTMLAttributes<HTMLDivElement> {
  image?: string
  value?: number
  size?: 'big' | 'medium' | 'small'
  externalCssScopedHash?: string
}

export default ({ id = '', className = '', image = '', value = 0, size = 'medium', externalCssScopedHash }: Props) => {
  ...
  return (
    <SqComponentWithExternalScopedCss hash={externalCssScopedHash}>
    ...
    </SqComponentWithExternalScopedCss>
  )
}
